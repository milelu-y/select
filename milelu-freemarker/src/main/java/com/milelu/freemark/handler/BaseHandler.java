...
public abstract class BaseHandler implements RenderHandler {
    ...
    public String getString(String name, String defaultValue) throws Exception {
        try {
            ...
            return CommonUtils.BeNotBlank(result) ? result : defaultValue;
        } catch (Exception e) {
            return defaultValue;
        }
    }
    ...
    public Character getCharacter(String name) throws Exception {
        ...
        if (CommonUtils.BeNotBlank(result)) {
    ...
    public int getInteger(String name, int defaultValue) {
        try {
            ...
            return CommonUtils.BeNotNull(result) ? result : defaultValue;
        } catch (Exception e) {
            return defaultValue;
        }
    }
...
//        }
    ...
    @Override
    public RenderHandler listToMap(String key, List<? extends BaseEntity> list) {

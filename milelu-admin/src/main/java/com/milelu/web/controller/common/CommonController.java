package com.milelu.web.controller.common;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = MileluConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = MileluConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    {
        // 本地资源路径
        String localPath = MileluConfig.getProfile();
        // 数据库资源地址
